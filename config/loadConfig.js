  ...
  try {
    ...
    try {
      ...
      if (projectId) {
          ...
          console.log('Nenhum ID de projeto na URL, tentando carregar local...');
      }
    } catch (sbError) {
...
function applyTypography(typography) {
  ...
  if (typography.sizeBase) root.style.setProperty('--size-base', typography.sizeBase);
  if (typography.sizeH1) root.style.setProperty('--size-h1', typography.sizeH1);
  if (typography.sizeH2) root.style.setProperty('--size-h2', typography.sizeH2);
