 ...
 const updatePaymentCardVisibility = () => {
  ...
  const renderCalendar = () => {
    ...
    const renderRange = () => {
      ...
      allDays.forEach(d => {
        d.classList.remove('is-selected', 'in-range', 'range-start', 'range-end');
        d.style.background = '';
        d.style.color = '';
        d.style.borderColor = '';
      });
      ...
      if (rangeStart && !rangeEnd) {
        ...
        rangeStart.style.background = 'var(--calendar-selected-bg)';
        rangeStart.style.color = 'var(--calendar-selected-text)';
        rangeStart.style.borderColor = 'var(--calendar-selected-bg)';
      ...
      if (rangeStart && rangeEnd) {
        ...
        allDays.forEach(d => {
          ...
          if (val >= s && val <= e) {
            ...
            d.style.background = 'var(--calendar-selected-bg)';
            d.style.color = 'var(--calendar-selected-text)';
            d.style.borderColor = 'var(--calendar-selected-bg)';
          }
        });
        setReserveEnabled(true);
        return;
